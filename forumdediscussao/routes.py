...
from forumdediscussao import app, database, bcrypt
from forumdediscussao.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from forumdediscussao.models import Usuario, Post
